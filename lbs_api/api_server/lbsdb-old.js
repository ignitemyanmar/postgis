...
exports.listPoi = function(conString, qData, callback){
	process.nextTick(function(){
		...
		var sql = "";
		if(cat_id == "")
			sql = "SELECT id, name, name_mm, cat_id, lon, lat,  room_no, building_no, building_name, street, quarter, township, city, country, zip_code   FROM poi order by id limit " + l + " offset " + ((p*l) - l);
		else
...
exports.serachPoibyId = function(conString, qData, callback) {
	var id = qData["poi_id"];
	process.nextTick(function(){
		sql = "SELECT id, name, name_mm, cat_id, lon, lat, room_no, building_no, building_name, street, quarter, township, city, country, zip_code  FROM poi where id="+id+"";
		sendDbQuery(conString, sql, callback);
	});
}
exports.latlngPoi = function(conString, qData, callback) {
	var id = qData["poi_id"];
	process.nextTick(function(){
		sql = "SELECT lon, lat FROM poi where id="+id+"";
		sendDbQuery(conString, sql, callback);
	});
}
/*
...
exports.searchPoi = function(conString, qData, callback){
	process.nextTick(function(){
		...
		if( poi_id != "")
			sql = "SELECT * FROM (SELECT id, name, name_mm, cat_id, lon, lat, room_no, building_no, building_name, street, quarter, township, city, country, zip_code  FROM osm_poi UNION SELECT id, name, name_mm, cat_id, geom, room_no, building_no, building_name, street, quarter, township, city, country, zip_code  FROM poi) as A where A.id="+ poi_id +" A.name like '%" + q + "%' order by id limit " + l + " offset " + ((p*l) - l);
		else if(cat_id != ""){
			sql = "SELECT * FROM (SELECT id, name, name_mm, cat_id, lon, lat, room_no, building_no, building_name, street, quarter, township, city, country, zip_code  FROM osm_poi UNION SELECT id, name, name_mm, cat_id, geom, room_no, building_no, building_name, street, quarter, township, city, country, zip_code  FROM poi) as A where A.cat_id = " + cat_id + " AND A.name like '%" + q + "%' order by id limit " + l + " offset " + ((p*l) - l);
		}
		else{
			sql = "SELECT * FROM (SELECT id, name, name_mm, cat_id, lon, lat, room_no, building_no, building_name, street, quarter, township, city, country, zip_code  FROM osm_poi UNION SELECT id, name, name_mm, cat_id, geom, room_no, building_no, building_name, street, quarter, township, city, country, zip_code  FROM poi) as A where A.name like '%" + q + "%' order by id limit " + l + " offset " + ((p*l) - l);
		}
